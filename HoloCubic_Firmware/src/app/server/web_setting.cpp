...
#define SETING_CSS ".input {display: block;margin-top: 10px;}"                                          \
                   ...
                   ".input input {height: 30px;width: 300px;}"                                          \
...
#define SETTING "<form method=\"GET\" action=\"saveConf\">"                                                                                                                                                                                                        \
                "<label class=\"input\"><span>WiFi 名称（2.4GHz）</span><input type=\"text\"name=\"ssid\"value=\"%s\"></label>"                                                                                                                                       \
                "<label class=\"input\"><span>WiFi 密码</span><input type=\"text\"name=\"pass\"value=\"%s\"></label>"                                                                                                                                            \
                "<label class=\"input\"><span>城市名称（拼音）</span><input type=\"text\"name=\"cityname\"value=\"%s\"></label>"                                                                                                                                          \
                "<label class=\"input\"><span>城市语言（默认：zh-Hans）</span><input type=\"text\"name=\"language\"value=\"%s\"></label>"                                                                                                                             \
                "<label class=\"input\"><span>天气API AppId（保持默认）</span><input type=\"text\"name=\"tianqiAppId\"value=\"%s\"></label>"                                                                                                                                        \
                "<label class=\"input\"><span>天气API AppSecret（保持默认）</span><input type=\"text\"name=\"tianqiAppSecret\"value=\"%s\"></label>"                                                                                                                                     \
                "<label class=\"input\"><span>屏幕亮度 （值为1~100）</span><input type=\"text\"name=\"backLight\"value=\"%u\"></label>"                                                                                                                           \
                "<label class=\"input\"><span>屏幕方向 （勿动！0~5可选）</span><input type=\"text\"name=\"rotation\"value=\"%u\"></label>"                                                                                                                         \
                "<label class=\"input\"><span>开机自动校准传感器</span><input class=\"radio\" type=\"radio\" value=\"0\" name=\"auto_calibration_mpu\" %s>关闭<input class=\"radio\" type=\"radio\" value=\"1\" name=\"auto_calibration_mpu\" %s>开启</label>" \
...
void Setting()
{
    ...
    if (0 == g_cfg.auto_calibration_mpu)
    {
        sprintf(buf, SETTING, g_cfg.ssid.c_str(), g_cfg.password.c_str(),
                ...
                g_cfg.tianqi_appid.c_str(), g_cfg.tianqi_appsecret.c_str(), 
